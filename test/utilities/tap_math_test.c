...
{
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(0, 0), 1));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(0, 1), 0));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(-1, 0), 1));
    assert(tap_math_isinf(tap_math_powf(0, -1)));

    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(42, 0), 1));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(42, 1), 42));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(42, 2), 1764));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(42, 3), 74088));
    ...
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(0.1F, -1), 10));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(1.5F, 42), 24878997.7221F));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_powf(1.5F, -42), 4.01945452614e-8F));
...
{
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_fabs(-0.0F), 0.0F));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_fabs(-1.0F), 1.0F));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_fabs(1.0F), 1.0F));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_fabs(-123.456F), 123.456F));
    assert(TAP_MATH_EQUAL_FLOAT(tap_math_fabs(123.456F), 123.456F));
}
